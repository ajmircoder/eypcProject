                ...
                <div className="carousel-container text-white">
                    <ul className="carousel my-carousel">
                        ...
                        <div className="carousel__controls">
                            <img src="https://assets-global.website-files.com/6493e2c640a47641d704896f/65041a02c256f83aea7af035_SeedToScale%20(1).webp" alt="" />
                        ...
                        <li className="carousel__slide">
                            <a className='w-full h-full block' href="https://www.seedtoscale.com/" target='_blank'></a>
                        ...
                        <li className="carousel__slide">
                            <a className='w-full h-full block' href="https://polygon.technology/" target='_blank'></a>
                        ...
                        <li className="carousel__slide">
                            <a className='w-full h-full block' href="https://www.letsventure.com/" target='_blank'></a>
                        ...
                        <li className="carousel__slide">
                            <a className='w-full h-full block' href="https://www.novabenefits.com/"></a>
                            <h1 className='carousel__controls_h1 md:text-3xl xl:text-5xl '>Nova benefits</h1>
                            <p className='carousel-container_h3 xl:text-xl '>UI/UX, 3D, Webflow, Interactions</p>
                        </li>
                        <li className="carousel__slide">
                            <a className='w-full h-full block' href=" https://www.novabenefits.com/" target='_blank'></a>
